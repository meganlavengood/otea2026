...
(function (global, factory) {
	typeof exports === "object" && typeof module !== "undefined" ? (module.exports = factory()) : typeof define === "function" && define.amd ? define("rat.Lightbox", factory) : ((global = typeof globalThis !== "undefined" ? globalThis : global || self), ((global.rat = global.rat || {}), (global.rat.Lightbox = factory())));
})(this, function () {
	"use strict";
	...
	class Lightbox {
                                        ...
                                        <div class="carousel-item${idx === 0 ? " active" : ""}">
                                            ...
                                            ${
												item.caption || item.title
													? `
                                                <div class="lightbox-caption d-none d-md-block">
		...
		show(source = null) {
			...
			if (this.legacy) {
				let events = ["slid.bs.carousel", "slide.bs.carousel", "hide.bs.modal", "hidden.bs.modal", "hidePrevented.bs.modal", "show.bs.modal", "shown.bs.modal"];
				for (let id of events) {
					(id.endsWith("modal") ? this.modal : this.carousel).on(id, (ev) => {
						(id.endsWith("modal") ? this.lightbox : this.lightbox.querySelector(".carousel")).dispatchEvent(
							new Event(id, {
								bubbles: ev.bubbles,
